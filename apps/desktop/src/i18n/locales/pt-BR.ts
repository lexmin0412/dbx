...
export default withEnglishFallback({
  ...
  vector: {
    ...
    productCollection: "Coleção de {product}",
    browse: "Navegar",
    search: "Pesquisar",
    ...
    run: "Executar",
    apply: "Aplicar",
    requestEditor: "Editor de solicitações vetoriais",
    operationSuccess: "Operação concluída. A visualização da coleção foi atualizada.",
    vectorLabel: "Vetor",
  },
  history: {
    title: "Histórico",
